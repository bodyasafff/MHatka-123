...
function DeleteProduct() {
    $.ajax({
        url: "http://localhost:51465/Admin/DeleteProduct",
        method: "POST",
        dataType: "json",
        data: {
            id: idproduct,
...
function DeleteSizeer() {
    $.ajax({
        url: "http://localhost:51465/Admin/DeleteSizeer",
        method: "POST",
        dataType: "json",
        data: {
            id: idsizeer,
...
function AddSizeAndPrice() {
    $.ajax({
        url: "http://localhost:51465/Admin/AddSizeAndPrice",
        method: "POST",
        dataType: "json",
        data: {
            id: idproduct,
...
function GetMinProduct(idProduct) {
    $.ajax({
        url: "http://localhost:51465/Admin/GetMinProduct?id=" + idProduct + "&token=" + window.sessionStorage.getItem("token"),
        method: "GET",
        success: function (data) {
            idproduct = data.id;
            $("#txt_minName").attr('value', data.name);
            $("#txt_minDescription").attr('value', data.description);
            $("#prodInfoPhotoo").attr('style', 'background: url(http://localhost:51465/Image/' + data.img + ');background-size:cover;')
        },
...
function AddProduct() {
    $.ajax({
        url: "http://localhost:51465/Admin/AddProduct",
        method: "POST",
        dataType: "json",
        data: {
            token: window.sessionStorage.getItem("token"),
...
function EditProduct() {
    $.ajax({
        url: "http://localhost:51465/Admin/EditProduct",
        method: "POST",
        dataType: "json",
        data: {
            token: window.sessionStorage.getItem("token"),
...
function GetProducts() {
    $.ajax({
        url: "http://localhost:51465/Admin/GetProducts?numPage=" + numThisPage + "&groupId=" + groupId + "&token=" + window.sessionStorage.getItem("token"),
        method: "GET",
        success: function (data) {
            $("#pagination").empty();
            massBtns = [];
...
function CreateGroupsToAdd(){
    $.ajax({
        url: "http://localhost:51465/Admin/GetMenu?token=" + window.sessionStorage.getItem("token"),
        method: "GET",
        success: function (data) {
...
function GetProduct() {
    $.ajax({
        url: "http://localhost:51465/Admin/GetProduct?id=" + idproduct + "&token="+ window.sessionStorage.getItem("token"),
        method: "GET",
        success: function (data) {
...
function uploadImage() {
    $('#uploadForm').ajaxForm(function (data) {
        $('#' + idPhoto + 'Photo').attr('style', 'background: url(http://localhost:51465/Image/' + data + ');background-size:cover;');
...
function postImage() {
$.ajax({
    url: "http://localhost:51465/Admin/GetImage",
    method: "POST",
    dataType: "json",
    data: {
        img:imgMass
